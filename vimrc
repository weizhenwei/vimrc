...
"
" Maintainer:	weizhenwei <weizhenwei1988@gmail.com>
" Last change:	2014 Aug 25
"
" To use it, copy it to
"     for Linux, Unix and OS/2:  ~/.vimrc
"	      for Amiga:  s:.vimrc
...
set textwidth=80	"set text width to 80, by wzw
set formatoptions+=mM              "set text widthto 80, auto \n
set number
set sw=4
set ts=4
set expandtab
...
"let Tlist_Show_One_File = 1            "不同时显示多个文件的tag，只当前文件的
...
if has("cscope")
    ...
    set cscopetag
    set csprg=/usr/bin/cscope "set by wzw, important!!!
